...
//       try {
//         const response = await axios.get("/api/line_graph");
...
const PowerChart = () => {
  const [data, setData] = useState("");
  const [error, setError] = useState("");
  const [timeframe, setTimeframe] = useState("1d"); // ค่าเริ่มต้นเป็น 1 วัน
  ...
  return (
    <div className="power-chart">
      ...
      <div className="timeframe-selector">
        {/* <label htmlFor="timeframe">เลือกช่วงเวลา: </label> */}
        <select
          id="timeframe"
          value={timeframe}
